...
def get_dealerships(request):
    if request.method == "GET":
        context = {}
        url = "https://eu-de.functions.appdomain.cloud/api/v1/web/Arska_Arska_GER/dealership-package/get-dealership"
...
def get_dealer_details(request, dealer_id):
    context = {}
    if request.method == "GET":
        url = 'https://eu-de.functions.appdomain.cloud/api/v1/web/Arska_Arska_GER/dealership-package/get-review'
...
def add_review(request, dealer_id):
    ...
    if request.user.is_authenticated:
        ...
        if request.method == "GET":
            url = f"https://eu-de.functions.appdomain.cloud/api/v1/web/Arska_Arska_GER/dealership-package/get-dealership?dealerId={dealer_id}"
        ...
        if request.method == "POST":
            ...
            url = "https://eu-de.functions.appdomain.cloud/api/v1/web/Arska_Arska_GER/dealership-package/post-review"  # API Cloud Function route
